...
class IzhikevichNullclines:
    ...
    def __init__(self, params, C=150e-3, c=-56, d=130, V_pico=50):
        self.params = params
        self.C = C
        self.c = c
        self.d = d
    ...
    def Izhi_calc(self, x, t, k, a, b, V_r, V_L, I):
    ...
    def plot_vector_field(self, ax, params, xrange, yrange, steps=50):
        ...
        dx, dy = self.Izhi_calc([X, Y], 0, **params)
    ...
    def nullclineV(self, v, k, a, b, V_r, V_L, I):
        return (k * (v - V_r) * (v - V_L)) + I

    def nullclineU(self, v, k, a, b, V_r, V_L, I):
        return b * (v - V_r)
    ...
    def plot_isocline(
        ...
        ax.plot(
            v,
            self.nullclineV(v, k, a, b, V_r, V_L, I),
            style,
            color=color,
            alpha=opacity,
        )
        ax.plot(
            v,
            self.nullclineU(v, k, a, b, V_r, V_L, I),
            style,
            color=color,
            alpha=opacity,
        )
    ...
    def jacobian_AdEx(self, v, k, a, b, V_r, V_L, I):
        return np.array([[k * (v - V_L) + k * (v - V_r), -1], [a * b, -a]])
    ...
    def plot_phase_diagram_Izhi(self, params, ax=None, title=None):
        ...
        for e, n in zip(eqnproot, eqstability):
            ...
            traj = izhikevich.run(J=[params["I"]], times=[(0, 0.45)], plot=False)
    ...
    def find_jacobian():
        ...
        v, u = sp.symbols("v, u")
        k, a, V_r, V_L, b, I = sp.symbols("k, a, V_r, V_L, b, I")
...
if __name__ == "__main__":
    params = {"k": 1.2, "a": 0.01, "b": 5, "V_r": -75, "V_L": -45, "I": 500}
    Izhinull = IzhikevichNullclines(params)
